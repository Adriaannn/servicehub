                                    ...
                                    try {
                                        ...
                                        foreach ($stmt as $row) {
                                            ...
                                            if ($row['status'] == 'A') {
                                                ...
                                                $status = "<button class='btn btn-success btn-sm btn-flat'>Declined</button>";
                                            ...
                                            $edit_btn = "";
                                            if ($row['status'] != 'I') {
                                                $status_btn = "<button class='btn btn-danger deactivate btn-sm btn-flat' data-id='" . $row['id'] . "'>Deactivate</button>";
...
$(document).ready(function() {
    ...
    if (isset($_POST['action']) && $_POST['action'] == 'deactivate') {
        ...
        try {
            $conn = $pdo->open();
            $stmt = $conn->prepare("UPDATE products SET status = 'I' WHERE id = :id");
            $stmt->execute(['id' => $id]);
